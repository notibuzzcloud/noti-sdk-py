...
def chats_archive(
    ...
    """
    Archive the chat (moves it to archived).
    ...
    Returns:
        Archive result.
    """
    path = _make_path("/api/{session}/chats/{chatId}/archive", path_params)
    return get_client().post(path, body)
...
def chats_unarchive(
    ...
    Returns:
        Unarchive result.
    """
    path = _make_path("/api/{session}/chats/{chatId}/unarchive", path_params)
    return get_client().post(path, body)
...
def chats_unread(
    ...
    Returns:
        Unread result.
    """
    path = _make_path("/api/{session}/chats/{chatId}/unread", path_params)
    return get_client().post(path, body)
