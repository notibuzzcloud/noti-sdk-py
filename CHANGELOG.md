...
### Added
- "Official documentation & DEMO" section in README with link to [notibuzz.com/api-docs](https://notibuzz.com/api-docs) and option to request a DEMO at [notibuzz.com](https://notibuzz.com)
- Support section entries for API docs and DEMO links
